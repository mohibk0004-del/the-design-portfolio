  ...
  return (
    <footer id="contact" className="relative z-10 w-full min-h-screen flex flex-col justify-end px-4 lg:px-14 py-32 md:py-48 bg-transparent overflow-hidden">
      <div className="max-w-6xl w-full relative z-10">
        <h2 className="footer-text font-bold uppercase text-[10vw] leading-[0.85] tracking-tight cursor-pointer hover:text-[var(--selection)] transition-colors duration-[250ms] ease-[cubic-bezier(0.23,1,0.32,1)] text-[var(--text-primary)]">
          Let's Create<br />
          Something<br />
          Extraordinary
        </h2>
