  ...
  return (
    <header className="fixed inset-0 pointer-events-none z-50 flex flex-col justify-between font-mono text-xs md:text-sm mix-blend-difference text-white">
      ...
      <div className="grid grid-cols-3 px-4 lg:px-14 py-4 lg:py-7 opacity-70 pointer-events-none items-end">
        ...
        <div className="text-center uppercase">{String(coords.x).padStart(4, '0')} X {String(coords.y).padStart(4, '0')} Y</div>
        <div className="text-right">
          <svg className="inline-block w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
        </div>
      </div>
    </header>
  )
