...
export default function HUD() {
  ...
  return (
    <header className="fixed inset-0 pointer-events-none z-50 flex flex-col justify-between font-mono text-xs md:text-sm text-[var(--text-primary)] transition-colors duration-300">
