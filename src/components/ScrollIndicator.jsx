...
export default function ScrollIndicator() {
  ...
  return (
    <div className="fixed right-3 sm:right-5 lg:right-8 top-1/2 -translate-y-1/2 z-50 pointer-events-none flex flex-col items-center gap-2 sm:gap-3 select-none transition-colors duration-300">
